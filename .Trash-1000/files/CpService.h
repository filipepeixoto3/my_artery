...
//     uint16_t detection_delta_time;
//     double depth;
//     omnetpp::cFigure::Point last_detection_coord;
//     omnetpp::cFigure::Point detection_coord;
//     double speed;
...
private:
	...
	std::map<int, tracks_info> tracks_map;
    std::map<int, tracks_info> past_tracks_map;
...
vanetza::asn1::Cpm createCollectivePerceptionMessage(const VehicleDataProvider& vdp, uint16_t genDeltaTime, const VehicleController& vc, std::map<int, uss_setup> us,std::map<int, uss_value> dm, std::map<int, tracks_info> tm, omnetpp::cGroupFigure& det, omnetpp::cFigure::Point cpc);
